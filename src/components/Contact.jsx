          ...
          <Col size={12} md={6}>
                ...
                <form onSubmit={handleSubmit}>
                  <Row className="contact-form">
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" value={formDetails.message} placeholder="Phone No." onChange={(e) => onFormUpdate('message', e.target.value)}/>
                    </Col>
                    <Col size={12} sm={6} md={12} className="px-1">
                      <textarea rows="6" value='' placeholder="Message" onChange=''></textarea>
